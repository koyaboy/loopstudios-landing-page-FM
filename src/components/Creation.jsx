...
const Creation = ({ image, title, type }) => {
    return (
        <div className='relative mb-5 w-full'>
            ...
            {type === "desktop" && <div className='text-2xl leading-none text-white absolute top-[75%] w-[77%] left-[12%] heading lg:top-[80%] lg:w-[75%] min-[897px]:top-[82%] z-20 lg:text-3xl xl:w-[60%]'>{title}</div>}
